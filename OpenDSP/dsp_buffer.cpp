...
namespace OpenDSP
{
    ...
    */
    ...
    dsp_buffer_ptr 
        dsp_make_buffer (int nitems, size_t sizeof_item, dsp_block_ptr link)
    {
        return dsp_buffer_ptr(new dsp_buffer(nitems, sizeof_item, link));
    }
    ...
    dsp_buffer::dsp_buffer (int nitems, size_t sizeof_item, dsp_block_ptr link)
        : m_base (0), m_bufsize (0), m_vmcircbuf (0),
        m_sizeof_item (sizeof_item),
        m_write_index (0), m_abs_write_offset(0),
        m_last_min_items_read(0), m_link(link)
    {
    ...
    dsp_buffer_reader_ptr
        dsp_buffer_add_reader (dsp_buffer_ptr buf, dsp_block_ptr link)
    {
        dsp_buffer_reader *r = new dsp_buffer_reader (buf, buf->m_write_index, link);
    ...
    //////////////////////////////////////////////////////////////////////////
    dsp_buffer_reader::dsp_buffer_reader(dsp_buffer_ptr buffer, unsigned int read_index, dsp_block_ptr link)
        : m_buffer(buffer), m_read_index(read_index), m_abs_read_offset(0), m_link(link)
    {
    }
