...
#define v_ctor(type)\
    __forceinline type(){};\
    __forceinline type(const type &d){this->m128i = d.m128i;}\
    __forceinline type(__m128  &d){this->m128 = d;}\
    __forceinline type(__m128i &d){this->m128i = d;}\
    __forceinline type(__m128d &d){this->m128d = d;}\
    template<typename OT> __forceinline type(vector1<OT> &v){ this->m128 = v.m128; }\
    __forceinline type& operator=(const type &d){this->m128 = d.m128; return (*this);}\
    __forceinline type& operator=(const __m128  &d){this->m128 = d; return (*this);}\
    __forceinline type& operator=(const __m128i &d){this->m128i = d; return (*this);}\
    __forceinline type& operator=(const __m128d &d){this->m128d = d; return (*this);}\
    template<typename OT> __forceinline type& operator=(vector1<OT> &d){ this->m128 = d.m128;  return (*this);}


#pragma region forward declarations
    struct v_b;  struct v_ub;
    struct v_cb; struct v_cub;

    struct v_s;  struct v_us;
    struct v_cs; struct v_cus;

    struct v_i;  struct v_ui;
    struct v_ci; struct v_cui;

    struct v_q;  struct v_uq;
    struct v_cq; struct v_cuq;

    struct v_f;  struct v_cf;
    struct v_q;  struct v_cq;
...
#pragma region "v_b"
    struct v_b : public vector1<signed __int8>
    {
        ...
        __forceinline v_b& v_set_b(char b0, char b1, char b2, char b3, char b4, char b5, char b6, char b7, char b8, char b9, char b10, char b11, char b12, char b13, char b14, char b15){ this->m128i = _mm_set_epi8(b15, b14, b13, b12, b11, b10, b9, b8, b7, b6, b5, b4, b3, b2, b1, b0);  return (*this); }
        __forceinline v_b& v_setall_b(char b){ this->m128i           = _mm_set1_epi8(b);  return (*this); }

        template<int idx>
        __forceinline v_b& v_set_at(int value){ this->m128i           = _mm_insert_epi8(this->m128i, value, idx);  return (*this); }
        template<int idx>
        __forceinline int v_get_at(int value){ return _mm_extract_epi8(this->m128i, idx); }
...
#pragma region "v_s"
    struct v_s : public vector1<signed __int16>
    {
        ...
        __forceinline v_s& v_set_s(short s0, short s1, short s2, short s3, short s4, short s5, short s6, short s7){ this->m128i = _mm_set_epi16(s7, s6, s5, s4, s3, s2, s1, s0); return (*this); }
        __forceinline v_s& v_setall_s(short s){ this->m128i                                                                     = _mm_set1_epi16(s); return (*this); }
...
#pragma region "v_i"
    struct v_i : public vector1<signed __int32>
    {
        ...
        __forceinline v_i& v_set_i(int i0, int i1, int i2, int i3){ this->m128i = _mm_set_epi32(i3, i2, i1, i0); return (*this); }
        __forceinline v_i& v_setall_i(int i){ this->m128i                       = _mm_set1_epi32(i); return (*this); }
...
#pragma region "v_ci"
    struct v_ci : public vector1<complex32>
    {
        ...
        __forceinline v_ci v_shuffle(){ v_ci c; c.m128d               = _mm_shuffle_pd(this->m128d, this->m128d, (a0 | (a1 << 1))); }
        template<int m0, int a0>
        __forceinline v_ci v_shuffle_with(v_ci &a){ v_ci c; c.m128d = _mm_shuffle_pd(this->m128d, a.m128d, (m0 | (a0 << 1))); }
...
#pragma region "v_q"
    struct v_q : public vector1<signed __int64>
    {
        ...
        __forceinline v_q& v_set_q(__m64 q0, __m64 q1){ this->m128i = _mm_set_epi64(q1, q0); return (*this); }
        __forceinline v_q& v_setall_q(__m64 q){ this->m128i         = _mm_set1_epi64(q); return (*this); }
...
#pragma region "v_cq"
    ...
    // keep high 32 bits
    __forceinline v_ci v_convert2ci(v_cq &a, v_cq &b){ v_ci c; c.m128 = _mm_shuffle_ps(a.m128, b.m128, _MM_SHUFFLE(2, 0, 2, 0)); }
...
#pragma region "v_dq"
    struct v_dq : public vector1<__int8>
    {
        ...
        template<int nBytes>
        __forceinline v_dq v_shift_left(){ v_dq c; c.m128i          = _mm_slli_si128(this->m128i, nBytes); return c; }
        template<int nBytes>
        __forceinline v_dq v_shift_right_logical(){ v_dq c; c.m128i = _mm_srli_si128(this->m128i, nBytes); return c; }
    };
#pragma endregion
...
#pragma region vector mask
    ...
    struct __declspec(align(16)) VMASK
    {
        ...
        __forceinline static const T __0x0000000000000000FFFFFFFFFFFFFFFF()
        {
            v_dq ret;
            ret.v_ones();
            ret = ret.v_shift_right_logical<8>();
            return (T)ret;
        }
        ...
        __forceinline static const T __0x000000000000000000000000FFFF0000()
        {
            v_dq ret;
            ret.v_ones();
            ret = ret.v_shift_right_logical<14>();
...
#pragma endregion vector mask
    ...
    __forceinline void v_complex2real(v_cb &c1, v_cb &c2, v_b &re, v_b &im){
        ...
        msk.v_set_b(0, 2, 4, 6, 8, 10, 12, 14, 1, 3, 5, 7, 9, 11, 13, 15);    
    ...
    __forceinline void  v_i::v_sqr2q(v_q &q0, v_q &q1){
        ...
        q24.m128i = _mm_mul_epi32(this->m128i, this->m128i); 
...
#define v_test_end }
    ...
    inline void v_print(FILE *File, v_cs &v)
    {
        for (int i = 0; i < v_s::elem_cnt; i++)
        {
            fprintf(File, "[%6d, %6d] ", v[i].re, v[i].im);
        }
        fprintf(File, "\n");
    }
